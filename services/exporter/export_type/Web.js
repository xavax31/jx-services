...
function publish(params) {
	...
	var paramsCloneProject = {
		...
		ext_exclude: ["sublime-project", "sublime-workspace", "fla", "mov", "as", "rtf", "zip", "as2proj", "pdf", "psd",  "txt", "bat", "rar", "dmg", "md"],   // exclude files with these extensions
	...
	if (params.jxSource == "current") {
		Cloner.cloneRep(paramsCloneJX,  bobaEnginePath , path.resolve(targetPath, "js/jx"));
		Cloner.cloneRep(paramsCloneJXLibs,  bobaEngineLibPath , path.resolve(targetPath, "js/lib"));
	}
